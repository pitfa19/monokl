...
description: >
  ...
  is (0, 0). Invoked via Jcode skill loader from the entry skill.
---
...
Return to the entry skill and begin the chapter execution loop at step 2 for the first chapter(s): `skill_manage load name="monokl-2-width-sweep")`.
