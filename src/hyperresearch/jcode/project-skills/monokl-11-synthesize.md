...
description: >
  ...
  via Jcode skill loader from the entry skill (full tier).
---
...
Spawn ONE `monokl-synthesizer` subagent. Single spawn, runs once.
...
```
skill_manage load name="monokl-12-critics")
```
